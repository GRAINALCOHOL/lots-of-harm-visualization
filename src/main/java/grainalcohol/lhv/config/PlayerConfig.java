...
public class PlayerConfig implements LHVConfigSupplier {
    public static final ConfigClassHandler<PlayerConfig> HANDLER = ConfigClassHandler.createBuilder(PlayerConfig.class)
            .id(LHVMod.id("player_config"))
            .serializer(config -> GsonConfigSerializerBuilder.create(config)
                    .setPath(LHVMod.CONFIG_DIR.resolve("lhv/player.json5"))
                    .setJson5(true)
                    .build())
            .build();
    ...
    public String killDisplay = "KILL!!";
    ...
    public String instantKillDisplay = "INSTANTLY";
